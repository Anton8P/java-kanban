...
public class Epic extends Task {
    ...
    public Epic withId(int newId) {
        return new Epic(newId, this.getType(), this.getTitle(), this.getDescription(), this.getStatus(), this.subtasksId);
    }

    public Epic withTitle(String newTitle) {
        return new Epic(this.getId(), this.getType(), newTitle, this.getDescription(), this.getStatus(), this.subtasksId);
    }

    public Epic withDescription(String newDescription) {
        return new Epic(this.getId(), this.getType(), this.getTitle(), newDescription, this.getStatus(), this.subtasksId);
    }

    public Epic withStatus(TaskStatus newStatus) {
        return new Epic(this.getId(), this.getType(), this.getTitle(), this.getDescription(), newStatus, this.subtasksId);
    }

    public Epic withSubtasks(List<Integer> newSubtasks) {
        return new Epic(this.getId(), this.getType(), this.getTitle(), this.getDescription(), this.getStatus(), newSubtasks);
    }
